...
namespace Workout_Planner.Controllers
{
    public class WorkoutsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,ProgamWeekID,Title,LastCompleted")] Workout workout)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,ProgamWeekID,Title,LastCompleted")] Workout workout)
        {
            if (id != workout.ID)
            {
                return NotFound();
